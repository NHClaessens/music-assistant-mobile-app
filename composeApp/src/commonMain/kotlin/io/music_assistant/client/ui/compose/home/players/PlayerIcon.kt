...
import io.music_assistant.client.ui.compose.common.icons.PlayerIcons
 ...
 * via [PlayerIcons], falling back to speaker icon when the name is empty/unknown.
 */
@Composable
fun PlayerIcon(
    player: Player,
    ...
    val iconRes = PlayerIcons.getIcon(player.icon)
    Icon(
